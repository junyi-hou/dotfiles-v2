((axis :source "elpaca-menu-lock-file" :recipe
 ...
 (clojure-ts-mode :source "elpaca-menu-lock-file" :recipe
                  (:package "clojure-ts-mode" :repo "clojure-emacs/clojure-ts-mode"
                            ...
                            :host github :ref "96fdffcbe9e1b8ebf9ad14e23b06f62cc3422e22"))
 (cond-let
 ...
 (consult :source "elpaca-menu-lock-file" :recipe
          (:package "consult" :repo "minad/consult" :fetcher github :files
                    ...
                    github :ref "1de751087e348b24c05e0b1dca16ced752e8f505"))
 (corfu :source "elpaca-menu-lock-file" :recipe
        (:package "corfu" :repo "minad/corfu" :files
                  ...
                  "5d7c697613ed2399c71e34e9f1cbd1ce8f8324cc"))
 ...
 (doom-themes :source "elpaca-menu-lock-file" :recipe
              (:package "doom-themes" :fetcher github :repo "doomemacs/themes" :files
                        ...
                        :source "MELPA" :protocol https :inherit t :depth treeless :host
                        github :ref "ad9b1bd1c21e25f044a4d2c3db41734666b00d16"))
 (eca :source "elpaca-menu-lock-file" :recipe
      (:package "eca" :fetcher github :repo "editor-code-assistant/eca-emacs" :files
                ("*.el") :source "MELPA" :protocol https :inherit t :depth treeless
                :host github :ref "d2a0a738e68c3d5ac8e4137de1e5bebf3637517d"))
              ...
              (:package "eldoc-mouse" :fetcher github :repo "huangfeiyu/eldoc-mouse"
                        ...
                        ("*.el" "*.el.in" "dir" "*.info" "*.texi" "*.texinfo" "doc/dir"
                         ...
                         (:exclude ".dir-locals.el" "test.el" "tests.el" "*-test.el"
                                   "*-tests.el" "LICENSE" "README*" "*-pkg.el"))
                        :source "MELPA" :protocol https :inherit t :depth treeless :host
                        github :ref "de48a1af46617861d38d9f96984869c21c0d887e"))
 (elisp-autofmt :source "elpaca-menu-lock-file" :recipe
                (:package "elisp-autofmt" :fetcher codeberg :repo
                          ...
                          :source "MELPA" :protocol https :inherit t :depth treeless
                          :host codeberg :ref "7c092f61dbf9673c9947c7048255c95b9d929204"))
        ...
        (:package "envrc" :fetcher github :repo "purcell/envrc" :files
                  ("*.el" "*.el.in" "dir" "*.info" "*.texi" "*.texinfo" "doc/dir"
                   ...
                   (:exclude ".dir-locals.el" "test.el" "tests.el" "*-test.el"
                             "*-tests.el" "LICENSE" "README*" "*-pkg.el"))
                  :source "MELPA" :protocol https :inherit t :depth treeless :host
                  github :ref "06d72d141ac2e2990d80cdb8bb84f6cb54c628a5"))
          ...
          (:package "hl-todo" :repo "tarsius/hl-todo" :fetcher github :files
                    ("*.el" "*.el.in" "dir" "*.info" "*.texi" "*.texinfo" "doc/dir"
                     ...
                     (:exclude ".dir-locals.el" "test.el" "tests.el" "*-test.el"
                               "*-tests.el" "LICENSE" "README*" "*-pkg.el"))
                    :source "MELPA" :protocol https :inherit t :depth treeless :host
                    github :ref "9540fc414014822dde00f0188b74e17ac99e916d"))
 ...
 (jarchive :source "elpaca-menu-lock-file" :recipe
           (:package "jarchive" :repo "https://git.sr.ht/~dannyfreeman/jarchive" :files
                     ("*" (:exclude ".git" "LICENSE")) :source "GNU ELPA" :protocol
                     https :inherit t :depth treeless :type git :ref
            ...
            (:package "orderless" :repo "oantolin/orderless" :fetcher github :files
                      ("*.el" "*.el.in" "dir" "*.info" "*.texi" "*.texinfo" "doc/dir"
                       ...
                       (:exclude ".dir-locals.el" "test.el" "tests.el" "*-test.el"
                                 "*-tests.el" "LICENSE" "README*" "*-pkg.el"))
                      :source "MELPA" :protocol https :inherit t :depth treeless :host
                      github :ref "aba87f2576e1d61e8f60ce8acdf6aca5c2da370c"))
         ...
         (:package "tempel" :repo "minad/tempel" :fetcher github :files
                   ("*.el" "*.el.in" "dir" "*.info" "*.texi" "*.texinfo" "doc/dir"
                    ...
                    (:exclude ".dir-locals.el" "test.el" "tests.el" "*-test.el"
                              "*-tests.el" "LICENSE" "README*" "*-pkg.el"))
                   :source "MELPA" :protocol https :inherit t :depth treeless :host
                   github :ref "abc41419e9eff719ccc8a156defb0e6db3b7f460"))
            ...
            (:package "transient" :fetcher github :repo "magit/transient" :files
                      ("*.el" "*.el.in" "dir" "*.info" "*.texi" "*.texinfo" "doc/dir"
                       ...
                       (:exclude ".dir-locals.el" "test.el" "tests.el" "*-test.el"
                                 "*-tests.el" "LICENSE" "README*" "*-pkg.el"))
                      :source "MELPA" :protocol https :inherit t :depth treeless :host
                      github :ref "06d5e8be1b3f1c9b4f184909edfa857cfbcab3c0"))
 (typst-ts-mode :source "elpaca-menu-lock-file" :recipe
                (:package "typst-ts-mode" :repo "meow_king/typst-ts-mode" :files
                          ("*" (:exclude ".git")) :source "NonGNU ELPA" :protocol https
                          :inherit t :depth treeless :host sourcehut :ref
 ...
 (vterm :source "elpaca-menu-lock-file" :recipe
        (:package "vterm" :fetcher github :repo "akermu/emacs-libvterm" :files
                  ...
                  :source "MELPA" :protocol https :inherit t :depth treeless :host
                  github :ref "a01a2894a1c1e81a39527835a9169e35b7ec5dec"))
