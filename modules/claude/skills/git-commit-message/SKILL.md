...
This skill generates a structured, informative git commit message based on the current staged changes and opens it in the user's preferred editor for final review and manual commit.
